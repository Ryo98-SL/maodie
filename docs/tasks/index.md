...
- `highlighting/`: syntax highlighting task chain, shared fixtures, and editor adapter contracts.
...
The highlighting task chain keeps lexer-backed token contracts, WASM/TS wrapper validation, shared fixtures, UTF-16 range conversion, and Web IDE/VSCode/JetBrains adapter contracts synchronized.
